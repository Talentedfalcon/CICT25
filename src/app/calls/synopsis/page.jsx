  ...
  return (
    <>
      <div className='flex flex-col justify-center items-center text-center p-5'>
        <div className='mb-10'>
          <h1 className='lg:text-5xl text-4xl font-bold text-[#222121]'>Call for Synopsis in Symposiums</h1>
        </div>
        <div className='flex md:flex-row flex-col w-full lg:w-3/4 mx-auto items-start md:text-lg lg:text-xl gap-4'>
          <div className='flex flex-col md:w-1/2 text-left'>
            <div className='my-4'>
              <h3 className='text-2xl mb-5 font-semibold text-[#222121]'>PhD Symposium</h3>
            ...
            <div className='my-4'>
              <h3 className='text-2xl mb-5 font-semibold text-[#222121]'>Published Indian Patent</h3>
            ...
            <div className='my-4'>
              <h3 className='text-2xl mb-5 font-semibold text-[#222121]'>M.Tech Symposium</h3>
            ...
            <div className='my-4'>
              <h3 className='text-2xl mb-5 font-semibold text-[#222121]'>B.Tech Symposium</h3>
            ...
            <div className='my-4'>
              <h3 className='text-2xl mb-5 font-semibold text-[#222121]'>Startups</h3>
