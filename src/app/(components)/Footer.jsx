...
const Footer = () => {
    return (
        <div className="bg-[#525A5B] flex flex-col text-white bottom-0 mt-auto p-4">
            <div className='w-full flex justify-center items-center xl:pl-24 h-auto'>
                <div className="flex flex-col justify-center items-center lg:flex-row lg:justify-center lg:items-center p-10 gap-16 lg:gap-12">
                    ...
                    <div className="flex flex-col justify-center items-center lg:items-start lg:w-1/3 w-4/5 text-center lg:text-left">
                        ...
                        <Button className="mt-4 w-3/5 h-12 bg-[#052E33] hover:bg-[#052E33] rounded-full text-white text-md font-semibold transition-transform hover:scale-105 ease-in-out transition-duration-300">
                    ...
                    <div className="flex flex-col items-center justify-start lg:items-start lg:w-1/3 w-full lg:pl-10 xl:pl-20 text-center lg:text-left">
                        ...
                        {[
                            ...
                            <Link key={index} href={link[1]} target="_blank" className="mb-2 text-white hover:text-[#F5DBA1] hover:text-opacity-60 transition-colors duration-300 ease-in-out
">
                                {link[0]}
                            </Link>
                        ))}
            ...
            <div className='w-4/5 justify-evenly items-center flex flex-col lg:flex-row self-center'>
                ...
                <div className='flex justify-center items-center gap-4 pb-4'>
                    <Link href={"#"} className='p-2 bg-black bg-opacity-30 rounded-full flex justify-center items-center hover:scale-110 hover:bg-[#F5DBA1]-400 hover:bg-opacity-50 transition-transform duration-300 ease-in-out'>
                    ...
                    <Link href={"#"} className='p-[9px] bg-black bg-opacity-30 rounded-full flex justify-center items-center hover:scale-110 hover:bg-[#F5DBA1]-400 hover:bg-opacity-50 transition-transform duration-300 ease-in-out'>
